...
<div class="maincont">
    ...
    <div class="index-pro1">
        <div class="index-pro1-list">
            <dl>
                <dt><a href="proinfo.html"><img src="{{url('images/pro1.jpg')}}" /></a></dt>
    ...
    <div class="prolist">
        <dl>
            <dt><a href="proinfo.html"><img src="{{url('images/prolist1.jpg')}}" width="100" height="100" /></a></dt>
            <dd>
    ...
    <div class="joins"><a href="fenxiao.html"><img src="{{url('images/jrwm.jpg')}}" /></a></div>
